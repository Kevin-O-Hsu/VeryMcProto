...
| 资源 | 链接 | 用途 |
|---|---|---|
| PacketEvents | https://docs.packetevents.com/ / https://modrinth.com/plugin/packetevents | **EasyPlace 降级方案**（拦截 `ServerboundUseItemOnPacket`）；见 [07](07-migration-architecture.md) §4、[08](08-implementation-plan.md) 7.1 |
