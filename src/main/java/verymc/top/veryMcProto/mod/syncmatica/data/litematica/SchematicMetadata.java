...
/**
 * 投影元数据（移植自 {@code ch.endte.syncmatica.litematica.schematic.SchematicMetadata}）。
 *
 * <p>Cloned from Litematica 1.21.5 -- Sakura。
 * 命令 {@code load} peek 时读取（Name / Author / EnclosingSize / TimeCreated 等）。
 */
public class SchematicMetadata
{
    ...
    public CompoundTag writeToNBT()
    {
        ...
        nbt.put("EnclosingSize", SyncmaticaUtil.createVec3iTag(this.enclosingSize));
