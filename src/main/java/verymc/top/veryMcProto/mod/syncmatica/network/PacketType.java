 ...
 * <ul>
 *   <li>{@link #REQUEST_LITEMATIC} 的 path 是 {@code request_download}（非 request_litematic）；</li>
 *   <li>{@link #MESSAGE} 的 path 是 {@code mesage}（原版拼写错误，注释「can't fix the typo here lol」，
 *       改了客户端认不出）。</li>
 * </ul>
 */
