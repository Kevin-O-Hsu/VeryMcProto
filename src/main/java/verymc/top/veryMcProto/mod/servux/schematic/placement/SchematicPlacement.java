    ...
    */
    ...
    public ImmutableMap<@NotNull String, @NotNull Box> getSubRegionBoxes(RequiredEnabled required)
    {
        ...
        for (Map.Entry<String, SubRegionPlacement> entry : this.relativeSubRegionPlacements.entrySet())
        {
            ...
            if (areaSize == null)
            {
                Reference.logger().warning("SchematicPlacement.getSubRegionBoxes(): Size for sub-region '" + name + "' not found in the schematic '" + this.schematic.getMetadata().getName() + "'");
                continue;
            }
    ...
    public ImmutableMap<@NotNull String, @NotNull Box> getSubRegionBoxFor(String regionName, RequiredEnabled required)
    {
        ...
        if (placement != null)
        {
            if (placement.matchesRequirement(required))
            {
                ...
                {
                    Reference.logger().warning("SchematicPlacement.getSubRegionBoxFor(): Size for sub-region '" + regionName + "' not found in the schematic '" + this.schematic.getMetadata().getName() + "'");
                }
            }
        }
