...
/**
 * MobCap 数据（mod 层）。照抄原版 {@code fi.dy.masa.servux.loggers.data.MobCapData}（去掉 Guava ImmutableList）。
 */
public class MobCapData
{
    ...
    public enum EntityCategory implements StringRepresentable
    {
        ...
        public static final List<EntityCategory> VALUES = java.util.Arrays.asList(values());
        ...
        public MobCategory getVanillaCategory() { return this.vanillaCategory; }
