...
/**
 * 哈希调色板（palette > 16，bits > 4，用 NMS {@link CrudeIncrementalIntIdentityHashBiMap}）。移植自原版
 * {@code ORIGIN/schematic/container/LitematicaBlockStatePaletteHashMap.java}（照抄，仅改 package + DataProviderManager import）。
 */
